...
{
    public partial class ContaLevantarFormViewModel : ObservableObject, INavigationAware
    {
        ...
        public ContaLevantarFormViewModel(
        ...
        [RelayCommand]
        private void OnLevantar()
        {
            _contaService.Levantar(this.Conta, this.Valor);
            this.Valor = 0;
        }
