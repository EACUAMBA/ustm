...
public class CreateContactService
{
    ...
    public int? Create(CreateContactRequest createContactRequest)
    {
        ...
        if(!contactListWithSamePhoneNumber.IsNullOrEmpty()){
            ...
            throw new ContactsManagerException(409, $"Contacto com o número ({contactWithSamePhoneNumber.PhoneNumber}) já existe, é do ({contactWithSamePhoneNumber.Name}) com email ({contactWithSamePhoneNumber.Email}).");
        }
